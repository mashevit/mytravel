 ...
 */
@Stateless(mappedName = "TripBe")
@LocalBean
public @Named("TBean") class TripBe implements TripBeRemote, TripBeLocal {
	@PersistenceContext(unitName = "TravelJpa1")
	EntityManager em;
	...
	public Trip getTripbyId(String idtrip) {
		int i = Integer.parseInt(idtrip);
		Trip tr = em.find(Trip.class, i);
		return tr;
	}
	
	public int updateTrip(String tripid, Date date, String numdays, String moneyspent, String hotel,
		String transit) {
		Trip trip = new Trip();
		trip.setTripDate(date);
		trip.setTripHotel(hotel);
